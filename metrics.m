...
%% =========================
beforeDir  = 'F:\%% Research Newwwww\Dr Yasser-Jeddah Project\archive\dataset\1\Cata-Before';   % <-- put BEFORE folder path
afterDir   = 'F:\%% Research Newwwww\Dr Yasser-Jeddah Project\archive\dataset\1\Cata-After';    % <-- put AFTER folder path
